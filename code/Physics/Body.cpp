...
Vec3 Body::WorlSpaceToBodySpace(const Vec3& worldPt) const {
...
void Body::Update(const float dt_sec) {
  ...
  // okayAwe have an angular velocity around the center of mass, this needs to be
  ...
  // Now get ther new model position
