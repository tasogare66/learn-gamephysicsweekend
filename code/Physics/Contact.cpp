...
void ResolveContact( contact_t & contact ) {
  ...
  const Mat3 invWorldInertiaA = bodyA->GetInverseInertiaTensorWorldSpace(); //Šµ«ƒ‚[ƒƒ“ƒg
  ...
  //
  // Calculate the impulse cased by friction
  //
  ...
  const Vec3 velNorm = n * n.Dot(vab); //Úü‘¬“x
